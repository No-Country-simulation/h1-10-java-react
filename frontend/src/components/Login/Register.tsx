...
export default function Register({isRegister: register = true}) {
 ...
 function onSubmit(values: z.infer<typeof formSchema>){
  ...
  return (
   <section className='w-full p-5 flex flex-col  text-amber-50  ' 
...
{/**Logo que puede cambiar */}
    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="  space-y-3 ">
      ...
      <Button onClick={()=>{setDesplegue(!desplegue)}}>Seleccione su perfil {'->'}</Button>
       <FormField
        control={form.control}
        name="perfil"
        render={({ field }) => (
          <section className='container-radios flex-col px-4 py-2 bg-white text-black rounded-lg'
           style={{
           ...
           <FormItem className='flex items-center justify-between'>
             ...
             <FormControl>
             <Input className='w-6' type='radio' placeholder='paciente' defaultChecked {...field} value={'paciente'}  
              style={{
                marginTop:0
              }} />
             </FormControl>
            ...
            <FormItem className='flex  items-center justify-between'>
              ...
              <FormControl>
              <Input className='w-6' type='radio' placeholder='paciente' {...field} value={'familiar del paciente'}   />
             </FormControl>
            </FormItem>
