    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "v1/api/user/getAll", "v1/api/user/**","v1/api/patient/**", "v1/api/medical-staff/getActive").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "v1/api/medical-staff/register").hasAnyRole("ADMIN")
