...
const SideBar = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className='bg-white lg:w-full' style={{ height: 'calc( 100vh - 16px)' }}>
      <label className='p-6 text-right lg:hidden' htmlFor='sidebarMobileCheckbox'>
        <p>X</p>
      </label>
      <input type='checkbox' className='peer hidden' id='sidebarMobileCheckbox' />
      <div className='opacity-0 transition-opacity peer-checked:opacity-100 lg:opacity-100'>
        <div className='p-6'>
